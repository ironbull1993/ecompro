                    ...
                    <div class="col-lg-8 col-xl-9">
                        <div class="row g-4">
                            ...
                            <div class="col-lg-6">
                                ...
                                <h5 class="fw-bold mb-3">Tsh {{ $product->price }}</h5>
                                ...
                                <div class="input-group quantity mb-5" style="width: 100px;">
                                    <div class="input-group-btn">
                                        <button data-id="{{$product->id}}" class="btn btn-sm btn-minus rounded-circle bg-light border qty_prod" >
                                ...
                                <button data-id="{{$product->id}}" class="btn border border-secondary rounded-pill px-3 text-primary add_product"><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</button>
                               @endif
                            </div>
                            <div class="col-lg-12">
                                <nav>
